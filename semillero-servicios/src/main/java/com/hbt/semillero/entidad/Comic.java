...
/**
 * 
 * <b>Descripción:<b> Clase que determina el mapeo de latabla comic de la BD DB_SEMILLERO
...
public class Comic implements Serializable{
	...
	/**
	 * Atributo que determina  un identificador unico para la clase
	 */
	...
	@Column(name = "SCID")
	//SEQ_COMIC nombre de la secuencia como esta en oracle
	//COMIC_SCID_GENERATOR es un nombre cualquiera y se forma asi(nombre de laclase+atributo+GENERATOR)
	private Long id;
	...
	public String toString() {
		return "Comic [id=" + id + ", nombre=" + nombre + ", editorial=" + Editorial + ", tematica=" + tematicaEnum
				+ ", coleccion=" + Coleccion + ", numeroPaginas=" + numeroPagina + ", precio=" + precio + ", autores="
